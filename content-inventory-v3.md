...
### 3.4a — Peng Dehuai: the cost of telling the truth

| # | Element | Content |
|---|---------|---------|
| 3.4a.1 | Contextual paragraph | `Not everyone lied. In July 1959, Marshal Peng Dehuai — China's defense minister and one of the most decorated commanders of the Korean War — wrote a private letter to Mao at the Lushan Conference. He called the backyard steel campaign "a waste of resources and manpower." He said the harvest numbers were inflated. He was right about everything.` |
| 3.4a.2 | Before/after image pair | Two images side by side. Left: `s1-peng-dehuai-military-portrait.jpg` (alt: "Marshal Peng Dehuai in military uniform before persecution"; caption: "Peng Dehuai — defense minister, war hero, veteran of Korea."). Right: `s1-peng-dehuai-struggle-session.jpg` (alt: "Marshal Peng Dehuai subjected to a struggle session by Red Guards"; caption: "The same man, after. Beaten until his back was broken. Died in prison, 1974."). |
| 3.4a.3 | Resolution paragraph | `Mao read the letter aloud to the Politburo — not to act on it, but to force everyone in the room to choose a side. Peng was stripped of all positions, placed under house arrest, and eventually handed to the Red Guards. The message was clear: the system does not lack information. It punishes the people who carry it. Every official in the chain below Peng understood what his fate meant for theirs.` |
...
| # | Element | Content |
|---|---------|---------|
| 5.14 | Image | `takeaway-fdr-portrait.jpg` — alt: "Franklin D. Roosevelt" — caption: "Franklin D. Roosevelt, 32nd President of the United States." Placed at the start of the FDR section as a visual anchor. |
| 5.15 | FDR paragraph | `Franklin Roosevelt won the 1936 election with 61% of the vote — the largest mandate since Monroe ran unopposed — and carried 46 of 48 states. When the Supreme Court kept striking down his New Deal legislation, he proposed packing the bench: adding up to six new justices, one for every sitting justice over seventy. The transparent goal was to fill the Court with allies. His own party killed the bill. The Senate voted 70 to 22 against their own president — the most popular leader in American history — because the institutional principle mattered more than the political alliance. Roosevelt remained president. He won two more elections. But the Court stayed at nine.` |
| 5.16 | Image | `takeaway-fdr-supreme-court-1937.png` — alt: "The nine justices of the U.S. Supreme Court, 1937" — caption: "The Hughes Court, 1937. Nine seats. Roosevelt wanted fifteen. The Senate said no." Placed after the FDR paragraph. |

### Counter-example 3 — Mandela, 1999

| # | Element | Content |
|---|---------|---------|
| 5.17 | Image | `takeaway-mandela-salute.jpg` — alt: "Nelson Mandela saluting a crowd" — caption: "Nelson Mandela, Galeshewe, South Africa." Placed at the start of the Mandela section. |
| 5.18 | Mandela paragraph | `Nelson Mandela spent twenty-seven years in prison and emerged to lead the dismantling of apartheid. He won South Africa's first democratic election in 1994 with 62% of the vote. His moral authority was absolute — no one would have objected to a second term, or a third. He served one and stepped down. In a continent where leaders routinely clung to power for decades, Mandela chose the institution over himself. But this is the hardest case: de Gaulle was constrained by a vote, Roosevelt was constrained by the Senate. Mandela was constrained by nothing except his own judgment. If a different person had stood where he stood — someone with the same charisma but less restraint — would South Africa's young institutions have held?` |
...
| `s1-peng-dehuai-military-portrait.jpg` | S3 Part 1, Peng Dehuai before/after (left) | Peng Dehuai in military uniform before persecution. |
| `s1-peng-dehuai-struggle-session.jpg` | S3 Part 1, Peng Dehuai before/after (right) | Marshal Peng Dehuai subjected to a struggle session by Red Guards. |
...
3. **Routinization pathway diagram (S1 Theory)** — three branching paths from charisma: routinized into bureaucracy (Lenin→Stalin), fractured into competing traditions (Muhammad), or constrained by institutions (answered in Takeaway). Path C illuminates in the Takeaway when the three counter-examples are presented.
...
6. **Peng Dehuai before/after (S3 Great Leap Forward)** — side-by-side photographs: a decorated marshal in uniform, then the same man being beaten in a struggle session. Visual proof of the cost of telling the truth.
7. **Testament manuscript interactive (S2 Case A)** — a Russian-language document image that reveals an English translation overlay on click, RE2-remake style. The "remove Stalin" line is highlighted red.
8. **Before/after photo sliders (S2 Case A)** — interactive proof that the Soviet state edited Trotsky and Yezhov out of existence in its own photographic record.
9. **Purge stat counters + victim grid (S2 Case A)** — quantifies the Great Purge in executed / gulag numbers and a dot grid.
10. **Islamic branch tree (S2 Case B)** — static SVG tree listing every major Sunni/Shia branch with hover tooltips; culminates in a death toll of 1,850,000+ across four modern sectarian wars.
11. **632 → 2026 sticky counter (S2 end)** — visually equates the passage of 1,394 years with a cumulative death toll climbing from 0 to 1,850,000. Sub-label acknowledges each conflict had its own political triggers.
12. **Inflate scrolly (S3 Great Leap Forward)** — visually dramatizes the harvest number growing 100 → 200 → 350 → 600 → 1,000 tons as each layer of the bureaucracy lies upward, then collapsing into famine.
13. **Famine counter (S3)** — counts up to an estimate of the Great Famine death toll (1959–61), with causal annotation and famine photograph.
14. **Dissonance demo (S3 Festinger)** — a two-button choice that delivers the same answer regardless: "In 1959, every official chose 'Reject.'"
15. **Polarization drift simulation (S3 bridge)** — ~60 dots drift from random scatter → group clusters → extreme-edge bubbles, illustrating Festinger → Sunstein → Pariser causal chain.
16. **Trial list (S3 Confession)** — five-row table of Old Bolsheviks and their verdicts, alongside Bukharin's portrait.
17. **Transition zone** — pure visual scrub from dark mode to light mode.
18. **De Gaulle referendum bar (Takeaway)** — horizontal bar showing 52.41% Non / 47.59% Oui. Visual mirror of the hemicycle vote — but this time, the vote constrains the leader.
...
20. **Routinization pathway callback (Takeaway)** — Path C from the Section 1 diagram illuminates, `?` replaced by `De Gaulle / FDR / Mandela`, with Mandela's label retaining a subtle pulse.
21. **Closing** — word-by-word reveal of Herbert's "beware of heroes" quote, followed by the final line.
